...
namespace MarvelApi_Api.Migrations
{
    ...
    [Migration("20240530001407_ModifyTeamModel")]
    partial class ModifyTeamModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarvelApi_Api.Models.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 5, 30, 0, 14, 7, 798, DateTimeKind.Utc).AddTicks(8450),
            ...
            modelBuilder.Entity("MarvelApi_Api.Models.Team", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 5, 30, 0, 14, 7, 798, DateTimeKind.Utc).AddTicks(8500),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
